...
public class PacMan extends JPanel implements ActionListener, KeyListener {
    ...
    boolean isPaused = false;//pause Flag
    ...
    public void draw(Graphics g) {
        ...
        if (gameOver) {
            ...
            g.drawString("High Score: " + highScore ,tileSize/2, tileSize/2+20);
        }
        else {
    ...
    public void keyReleased(KeyEvent e) {
        ...
        if (e.getKeyCode() == KeyEvent.VK_P) {
            isPaused = !isPaused; // ✅ toggles pause on/off
            System.out.println("Paused: " + isPaused); // debug print
        }
